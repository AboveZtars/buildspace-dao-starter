...
dotenv.config();
console.log(process.env.REACT_APP_DROP_MODULE_ADDRESS);
...
const App = () => {
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your free 🎮MegamanDAO Membership NFT</h1>
